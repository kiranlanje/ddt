...
public class DbTestData {
    ...
    public static Collection testData() throws Exception {
        return  getTestData("test\\resources\\data\\BmiTesting.mdb","SELECT Height, Weight, Bmi, Category FROM TestData");
    }
	...
	public static Collection<String[]> getTestData(String mdbFile, String sqlQuery) throws Exception { 
	       ...
	       * con=DriverManager.getConnection("jdbc:mysql://localhost:3306/paratus","mysql","mysql");
	       */
	      Statement stmt = null;
	      ResultSet rs = null;
